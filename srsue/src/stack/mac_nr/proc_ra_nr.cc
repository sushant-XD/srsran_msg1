...
void proc_ra_nr::ra_preamble_transmission()
{
  ...
  // NOTE: prach occassion is always zero and our system only supports msg1_fdm=1
  prach_occasion = 0;
  ...
  logger.info("Sending PRACH ON INDEX: %d preamble index: %d", preamble_index, prach_occasion);
