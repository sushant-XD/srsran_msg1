...
SRSRAN_API int srsran_prach_gen_all(srsran_prach_t* p, uint32_t freq_offset, cf_t* signal);
SRSRAN_API int srsran_prach_gen_cancellation(srsran_prach_t* p, uint32_t freq_offset, cf_t* signal);
